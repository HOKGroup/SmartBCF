...
namespace HOK.SmartBCF.BCFDBReader
{
    ...
    public static class BCFDBReader
    {
        ...
        /// <summary>
        /// SQLite connection version 3 to support UNC path
        /// </summary>
        ...
        /// <summary>
        /// Read all tables and stores in memory
        /// </summary>
        /// <param name="dbFile"></param>
        /// <returns></returns>
