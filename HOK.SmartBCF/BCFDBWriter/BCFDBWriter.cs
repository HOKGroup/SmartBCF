...
namespace HOK.SmartBCF.BCFDBWriter
{
    ...
    public static class BCFDBWriter
    {
        ...
        /// </summary>
        /// <param name="dbFile">file name of the database</param>
        /// <returns></returns>
                ...
                if (File.Exists(databaseFile))
                {
                    using (SQLiteTransaction trans = sqlConnection.BeginTransaction())
                    {
                        try
                        {
                            ...
                            {
                                //list of SQL query to create tables are stored in Resources
        ...
        public static bool WriteDatabase(BCFZIP bcfzip, ConflictMode mode)
        {
            ...
            try
            {
                ...
                ProgressManager.databaseFilePath = databaseFile;
                //follow this order for the relationship of database
        ...
        /// <summary>
        /// Merge a new bcf into the exisiting one
        /// </summary>
        /// <param name="bcfzip"></param>
        /// <param name="oldBCF"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Insert into ProjectExtension and Project table
        /// </summary>
        /// <param name="bcfZip"></param>
        /// <param name="mode"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Insert Markup Values
        /// </summary>
        /// <param name="fileId">id of the bcfzip file</param>
        ...
        /// <summary>
        /// Insert Comment values into the table
        /// </summary>
        ...
        /// <summary>
        /// Insert Extension values into the table
        /// </summary>
        /// <param name="bcfZip"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Insert VisInfo values into tables
        /// </summary>
        ...
        /// <summary>
        /// Delete all information related to a certain BCF
        /// </summary>
        /// <param name="bcfzip"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Delete Makrup and Viewpoint of a certain topic id
        /// </summary>
        /// <param name="markup"></param>
        /// <param name="cmd"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Update RevitExtensions - Revit specific info
        /// </summary>
        ...
        /// <summary>
        /// Update multiple Revit Extensions
        /// </summary>
